...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheTvdbApiV2.AuthenticationString();
  });
  ...
  describe('AuthenticationString', function() {
    it('should create an instance of AuthenticationString', function() {
      // uncomment below and update the code to test AuthenticationString
      //var instane = new TheTvdbApiV2.AuthenticationString();
      //expect(instance).to.be.a(TheTvdbApiV2.AuthenticationString);
    });
