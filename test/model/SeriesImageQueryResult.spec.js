...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheTvdbApiV2.SeriesImageQueryResult();
  });
  ...
  describe('SeriesImageQueryResult', function() {
    it('should create an instance of SeriesImageQueryResult', function() {
      // uncomment below and update the code to test SeriesImageQueryResult
      //var instane = new TheTvdbApiV2.SeriesImageQueryResult();
      //expect(instance).to.be.a(TheTvdbApiV2.SeriesImageQueryResult);
    });
    ...
    it('should have the property ratingsInfo (base name: "ratingsInfo")', function() {
      // uncomment below and update the code to test the property ratingsInfo
      //var instane = new TheTvdbApiV2.SeriesImageQueryResult();
      //expect(instance).to.be();
    });
