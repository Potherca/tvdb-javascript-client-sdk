...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheTvdbApiV2.FilterKeys();
  });
  ...
  describe('FilterKeys', function() {
    it('should create an instance of FilterKeys', function() {
      // uncomment below and update the code to test FilterKeys
      //var instane = new TheTvdbApiV2.FilterKeys();
      //expect(instance).to.be.a(TheTvdbApiV2.FilterKeys);
    });
