...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheTvdbApiV2.SeriesImagesQueryParam();
  });
  ...
  describe('SeriesImagesQueryParam', function() {
    it('should create an instance of SeriesImagesQueryParam', function() {
      // uncomment below and update the code to test SeriesImagesQueryParam
      //var instane = new TheTvdbApiV2.SeriesImagesQueryParam();
      //expect(instance).to.be.a(TheTvdbApiV2.SeriesImagesQueryParam);
    });
