...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheTvdbApiV2.LanguageData();
  });
  ...
  describe('LanguageData', function() {
    it('should create an instance of LanguageData', function() {
      // uncomment below and update the code to test LanguageData
      //var instane = new TheTvdbApiV2.LanguageData();
      //expect(instance).to.be.a(TheTvdbApiV2.LanguageData);
    });
