...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheTvdbApiV2.NotAuthorized();
  });
  ...
  describe('NotAuthorized', function() {
    it('should create an instance of NotAuthorized', function() {
      // uncomment below and update the code to test NotAuthorized
      //var instane = new TheTvdbApiV2.NotAuthorized();
      //expect(instance).to.be.a(TheTvdbApiV2.NotAuthorized);
    });
