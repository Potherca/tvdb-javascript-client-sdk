...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheTvdbApiV2.AuthenticationApi();
  });
  ...
  describe('AuthenticationApi', function() {
    ...
    describe('refreshTokenGet', function() {
      it('should call refreshTokenGet successfully', function(done) {
        //uncomment below and update the code to test refreshTokenGet
        //instance.refreshTokenGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
